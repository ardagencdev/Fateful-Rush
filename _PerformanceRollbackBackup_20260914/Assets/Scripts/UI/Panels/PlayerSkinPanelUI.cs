...
public class PlayerSkinPanelUI : MonoBehaviour
{
    ...
    private PointerEventData swipePointerData;
        ...
        Vector2 screenPosition)
    {
        ...
        if (swipePointerData == null)
            swipePointerData = new PointerEventData(EventSystem.current);

        swipePointerData.position = screenPosition;
