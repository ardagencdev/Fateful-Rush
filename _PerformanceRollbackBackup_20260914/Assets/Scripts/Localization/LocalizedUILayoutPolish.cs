...
public sealed class LocalizedUILayoutPolish : MonoBehaviour
{
    ...
    {
        // Let panel activation / LayoutGroups settle first.
        yield return null;
        ...
        // One final pass handles layout values that become valid only after
        // the first rebuilt canvas. Then the routine stops completely.
        yield return null;
        Canvas.ForceUpdateCanvases();
        AlignHudOpacitySliders();
